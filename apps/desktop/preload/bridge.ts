              ...
              : input.command.type === "application-spec.revise" ||
                ...
                : input.command.type === "code-review.start" ||
                  ...
                  : input.command.type.startsWith("integration.")
                    ...
                    : input.command.type === "test.case-revision.register"
                      ? TestCaseRevisionViewSchema.parse(result.value)
                      : input.command.type.startsWith("test.")
                        ? TestRunViewSchema.parse(result.value)
